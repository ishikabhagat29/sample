...
class handling:
    def new_param(random_numbers):
        """A function to create t6he data into json file """
        try:
    ...
    def new_entry(random_parameters):
        """A function to convert the data into json file"""
        try:
    ...
    def generate_report():
        """A function to generate report of the data generated by the device in json file"""
        try:
    ...
    def get_file():
        """A function to download the report generated in json format """
         try:
